            ...
            <div class="hero  my-10">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='px-6'>
                        ...
                        <p class="py-6  text-gray-600">I'm a professional Front-End Web Developer with <span className='text-green-400 font-semibold' >M</span>
                            ...
                            I've completed more than 20 websites. If you need any help to build your website feel free to contact with me.</p>
